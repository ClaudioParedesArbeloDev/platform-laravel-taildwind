...
<div class="text-text-900 font-one flex justify-center">
    <div class="lg:w-4/6 lg:py-8 flex flex-col">
        ...
        <img src="{{ $blog->image }}" alt="blogImage" class="w-full h-60 object-cover py-4 lg:w-200 lg:h-150 lg:my-8 lg:mx-auto">
