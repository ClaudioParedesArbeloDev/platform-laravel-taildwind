    ...
    <div class="bg-background-100">
        <div class="h-screen flex overflow-hidden bg-background-300">
            <script>
                ...
                document.write(
                    `<div id="sidebar" class="bg-background-500 text-text-700 min-h-screen flex flex-col justify-between overflow-y-auto transition-width duration-300 ease-in-out ${isExpanded ? 'w-50' : 'w-20'}">`
                );
            </script>
                    ...
                    <ul class="mt-4 space-y-4">
                        ...
                        <li>
                            <a href="{{route('profile.edit')}}" class="flex items-center space-x-2 hover:text-accent2-700 pt-4">
                                ...
                                <span class="sidebar-text">{{__('profile')}}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('dashboard.mypath')}}" class="flex items-center space-x-2 hover:text-accent2-700 pt-4">
                                <span class="material-symbols-outlined">route</span>
                                <span class="sidebar-text">{{__('my path')}}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('dashboard.cursos')}}" class="flex items-center space-x-2 hover:text-accent2-700 pt-4">
                ...
                <div class="flex justify-center gap-x-2 p-1 mb-4 lg:gap-x-4 items-center">
                    ...
                    <a href="/locale/es"><img src="{{asset('images/spain.jpg')}}" alt="Spain Flag" class="lang w-10 h-auto"></a>
                    <script>
                        const isExpanded = localStorage.getItem('sidebarExpanded') === 'true';
                        document.querySelectorAll('.sidebar-text, .lang').forEach(el => {
